...
Version  : 1.3.2
Release  : 31
URL      : https://cran.r-project.org/src/contrib/geepack_1.3-2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/geepack_1.3-2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609280619
...
/usr/lib64/R/library/geepack/NEWS
